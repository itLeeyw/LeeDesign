...
export var Button = function (props) {
    var _a;
    var btnType = props.btnType, className = props.className, disabled = props.disabled, href = props.href, size = props.size, children = props.children, restProps = __rest(props, ["btnType", "className", "disabled", "href", "size", "children"]);
    // lee-btn, btn-large, btn-primary...
    var classes = classNames('lee-btn', className, (_a = {},
